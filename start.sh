...
prompt_default "LICENSE_SIGNING_PRIVATE_KEY_FILE" "${APP_DIR}/.sc1forcr-license-ed25519-private.pem" LICENSE_SIGNING_PRIVATE_KEY_FILE
prompt_default "LICENSE_SIGNING_PUBLIC_KEY_FILE" "${APP_DIR}/.sc1forcr-license-ed25519-public.pem" LICENSE_SIGNING_PUBLIC_KEY_FILE
prompt_default "LICENSE_LEASE_TTL_SECONDS" "21600" LICENSE_LEASE_TTL_SECONDS
prompt_default "LICENSE_LEASE_GRACE_SECONDS" "86400" LICENSE_LEASE_GRACE_SECONDS
prompt_default "LICENSE_REQUIRE_MACHINE_ID" "1" LICENSE_REQUIRE_MACHINE_ID
prompt_default "LICENSE_ENFORCE_SOURCE_IP" "1" LICENSE_ENFORCE_SOURCE_IP
prompt_default "LICENSE_ALLOW_LEGACY_BEARER (1 selama migrasi)" "1" LICENSE_ALLOW_LEGACY_BEARER
...
LICENSE_SIGNING_PRIVATE_KEY_FILE=${LICENSE_SIGNING_PRIVATE_KEY_FILE}
LICENSE_SIGNING_PUBLIC_KEY_FILE=${LICENSE_SIGNING_PUBLIC_KEY_FILE}
LICENSE_LEASE_TTL_SECONDS=${LICENSE_LEASE_TTL_SECONDS}
LICENSE_LEASE_GRACE_SECONDS=${LICENSE_LEASE_GRACE_SECONDS}
LICENSE_REQUIRE_MACHINE_ID=${LICENSE_REQUIRE_MACHINE_ID}
LICENSE_ENFORCE_SOURCE_IP=${LICENSE_ENFORCE_SOURCE_IP}
LICENSE_ALLOW_LEGACY_BEARER=${LICENSE_ALLOW_LEGACY_BEARER}
EOF
